            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 space-y-8">
              <section>
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  KlawKeeper.world ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you use our secure email service.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-700 dark:text-gray-300 mb-4">
                  KlawKeeper implements zero-knowledge encryption, which means:
                </p>
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300 ml-4">
                  <li>Email address (username@klawkeeper.xyz)</li>
              ...
              <section>
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  KlawKeeper does not share your data with third-party advertisers or data brokers. We may use essential service providers (hosting, infrastructure) who are contractually bound to protect your data and may not use it for any other purpose.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  KlawKeeper is not intended for users under 13 years of age. We do not knowingly collect personal information from children. If we become aware that a child has provided us with personal information, we will delete it immediately.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  Our services are operated globally. By using KlawKeeper, you consent to the transfer of your information to countries where we operate. We ensure appropriate safeguards are in place to protect your data.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-700 dark:text-gray-300 mt-4">
                  Email: privacy@klawkeeper.xyz<br />
                  Security Issues: security@klawkeeper.xyz
                </p>
              </section>
            </div>
          </div>
